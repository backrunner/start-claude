export function pruneMissingExtensionReferences(configFile) {
...
function pruneConfigReferences(config, library) {
...
function keepExistingOptionalIds(ids, definitions) {
    return ids ? keepExistingIds(ids, definitions) : undefined;
}
function keepExistingIds(ids, definitions) {
