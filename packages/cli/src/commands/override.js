...
export async function handleOverrideCommand() {
...
export async function handleOverrideDisableCommand() {
    const ui = new UILogger();
    ui.displayWelcome();
    const configManager = ConfigManager.getInstance();
    const overrideManager = OverrideManager.getInstance();
...
export async function handleOverrideStatusCommand() {
    const ui = new UILogger();
    ui.displayWelcome();
    const overrideManager = OverrideManager.getInstance();
    const shellInfo = overrideManager.getShellInfo();
...
export async function handleOverrideShellsCommand() {
    const ui = new UILogger();
    ui.displayWelcome();
    const overrideManager = OverrideManager.getInstance();
    const shellInfo = overrideManager.getShellInfo();
